...
PRIVACY_EFFECTIVE_DATE = "2026-06-12"
...
PRIVACY_SECTIONS = [
    ...
    {
        "title": "2. 개인정보 이용 목적",
        "body": "수집한 정보는 회원 식별, 로그인, 러닝 기록 관리, 목표와 챌린지 제공, 사진/영상 업로드와 조회, AI 기반 기록 분석과 대화 제공, 체중 변화 관리, 고객 지원, 보안 감사, 부정 이용 방지, 사용량 제한과 서비스 안정성 개선에 사용됩니다.",
    },
    {
        "title": "3. 보관 기간",
